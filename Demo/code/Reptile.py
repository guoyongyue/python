...
class music:
    ...
    def get_hotcomments(self, url):
        ...
        f = open('E:/work/github/python/Demo/source/file/test2.txt', 'w', encoding='utf-8')
    ...
    def get_allcomments(self, url):
        ...
        f = open('E:/work/github/python/Demo/source/file/test1.txt', 'w', encoding='utf-8')
        present_page = 0
...
mail = music()
mail.get_hotcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_1342633205?csrf_token")
mail.get_allcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_1342633205?csrf_token")
